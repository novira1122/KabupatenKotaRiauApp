package id.ac.polbeng.noviraasnani.kabupatenkotariauapp
...
import id.ac.polbeng.noviraasnani.kabupatenkotariauapp.databinding.ItemCardKabkotaBinding
...
RecyclerView.Adapter<CardKabKotaAdapter.CardViewHolder>() {
    ...
    Int): CardViewHolder {
        val binding = ItemCardKabkotaBinding.inflate(LayoutInflater.from(parent.context
        ), parent, false)
