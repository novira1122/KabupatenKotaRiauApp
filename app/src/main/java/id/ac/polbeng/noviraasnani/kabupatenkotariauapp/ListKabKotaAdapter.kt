...
import id.ac.polbeng.noviraasnani.kabupatenkotariauapp.databinding.ItemListKabkotaBinding
...
class ListKabKotaAdapter(private val listKabKota: ArrayList<KabKota>):
    ...
    Int): ListViewHolder {
        val binding =
            ItemListKabkotaBinding.inflate(LayoutInflater.from(parent.context
            ), parent, false)
